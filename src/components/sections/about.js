  ...
  const data = useStaticQuery(graphql`
    query {
      avatar: file(sourceInstanceName: { eq: "images" }, relativePath: { eq: "me.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 500, traceSVG: { color: "#64ffda" }, quality: 100) {
      ...
      <div className="inner">
        <StyledText>
          <div>
            ...
            <p>
              I’m Mani and I am passionate about
              making the web feel more like home by creating software experiences that not only serve their purpose
              well,
