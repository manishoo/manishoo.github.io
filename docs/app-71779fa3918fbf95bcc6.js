  ...
  [2],
  {
    '+ZDr': function (t, e, n) {
      ...
      function h(t, e) {
        ...
        const o =
          null !== (n = null !== (r = e) && void 0 !== r ? r : v()) && void 0 !== n ? n : '/';
        return `${(null == o ? void 0 : o.endsWith('/')) ? o.slice(0, -1) : o}${
          t.startsWith('/') ? t : `/${t}`
        }`;
      }
      var v = function () {
        ...
        return (
          !a &&
            ...
            r.addEventListener(
              'DOMContentLoaded',
              (e = function () {
                for (r.removeEventListener('DOMContentLoaded', e), a = 1; (e = n.shift()); ) {
                  e();
                }
              }),
            ),
    ...
    SFrS: function (t, e, n) {
      ...
      t.exports = function (t, e) {
        let n;
        let o;
        if ('string' === e && 'function' === typeof (n = t.toString) && !r((o = n.call(t)))) {
          return o;
        }
      ...
      const k = (function (t) {
        ...
        return (
          ...
          (n.shouldComponentUpdate = function (t) {
            return !!j(t.location, this.props.location) && (x(this.props.location, t.location), !0);
          }),
          (n.componentDidUpdate = function (t) {
    ...
    pWkz: function (t, e, n) {
      ...
      e.onRouteUpdate = function (t, e) {
        const n = t.location;
        if ((void 0 === e && (e = {}), 'function' !== typeof ga)) {
          return null;
        }
        if (
          n &&
    ...
    wE6v: function (t, e, n) {
      ...
      t.exports = function (t, e) {
        ...
        const u = t[i];
        if (void 0 !== u) {
          if ((void 0 === e && (e = 'default'), (n = u.call(t, e)), !r(n) || o(n))) {
            return n;
          }
          throw TypeError("Can't convert object to primitive value");
        }
